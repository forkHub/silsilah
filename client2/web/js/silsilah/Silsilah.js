    ...
    (function (sl) {
        class App {
            ...
            async loadAnggota(id) {
                let anggota = (await ha.sl.anggotaDao.bacaId(id))[0];
            ...
            renderAnggota(anggota, cont, indek, loadOtomatis) {
                ...
                view.img.src = anggota.foto ? anggota.foto : sl.RouterKOns.server + '/gbr/thumb.png';
                ...
                view.profileUtama.onclick = (e) => {
                    ...
                    window.location.href = sl.RouterKOns.server + ha.comp.Util.getUrl(ha.sl.RouterKOns.g_beranda_lihat_id, [id]);
                };
                view.profilePasangan.onclick = (e) => {
                    ...
                    console.debug('id : ' + e.currentTarget.getAttribute('id'));
                    let id = e.currentTarget.getAttribute('id');
                    window.location.href = ha.comp.Util.getUrl(sl.RouterKOns.g_beranda_lihat_id, [id]);
                };
                view.attach(cont);
                ...
                if (!view.anggota.populated) {
                    ...
                    if (view.anggota.rel_id) {
                        ...
                        if (pas) {
                            ...
                            view.imgPasangan.src = pas.foto ? pas.foto : (sl.RouterKOns.server + '/gbr/thumb.png');
