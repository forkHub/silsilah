...
class Router {
    ...
    mapRouter() {
        ...
        this.router.get(RouterKons_1.RouterKOns.g_anggota_id_pas_tambah, SilsilahModule_1.sm.auth.checkAuthGet, SilsilahModule_1.sm.cont.relasi.renderTambahPasangan);
        this.router.get(RouterKons_1.RouterKOns.g_anggota_id_pas_tambah_kunci_hal, SilsilahModule_1.sm.auth.checkAuthGet, SilsilahModule_1.sm.cont.relasi.renderTambahPasangan);
